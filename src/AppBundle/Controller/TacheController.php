...
class TacheController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AppBundle:Tache:index.html.twig', array(
            'taches' => $taches,
        ));
    }
    /**
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('AppBundle:Tache:new.html.twig', array(
            'tache' => $tache,
    ...
    public function showAction(Tache $tache)
    {
        ...
        return $this->render('AppBundle:Tache:show.html.twig', array(
            'tache' => $tache,
    ...
    public function editAction(Request $request, Tache $tache)
    {
        ...
        return $this->render('AppBundle:Tache:edit.html.twig', array(
            'tache' => $tache,
